...
def calc_outers(X, Y=None, diff=True):
    """
    ...
    Y : Numpy array, shape (M x e), default=None

        A 2D-array, where M is the number of samples in Y and e is the number of features.
